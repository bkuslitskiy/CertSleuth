    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True)),
                ('role', models.CharField(choices=[('user', 'User'), ('approver', 'Approver'), ('admin', 'Admin')], default='user', max_length=16)),
                ('timezone', models.CharField(default='America/New_York', max_length=64)),
                ('gmail_scan_enabled', models.BooleanField(default=False)),
                ('ics_token', models.CharField(blank=True, max_length=64, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending console add'), ('done', 'Enrolled'), ('declined', 'Declined')], default='pending', max_length=16)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
