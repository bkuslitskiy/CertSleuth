...
| V4 | Access control | planned | Server-side role checks per route (User/Approver/Admin); Postgres RLS second layer; worker tokens scoped claim/submit-to-staging only | SEC-004, SEC-008 | 2026-07-16 |
...
| V11 | Business logic | planned | Crawl-on-demand gate for community sources (SEC-007); waitlist cap logic; lease TTL on job claims | SEC-007 | 2026-07-16 |
